...
$Expected Return = \alpha + \beta_{1}*LastFiveStarts + \beta_{2}*DaysSinceLastRun + \beta_{3}*Handicap + \beta_{4}*Barrier + \beta_{5}*Form + \beta_{6}*\frac{1}{odds} + \beta_{7}*\frac{1}{odds}^2 + \epsilon$
